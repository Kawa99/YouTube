...
def upgrade():
    ...
    sa.Column('recorded_at', sa.Text(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    ...
    sa.Column('saved_at', sa.Text(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
